          ...
          <div class="card card-signup text-center">
            ...
            <div class="card-body ">
              <form method="POST" action="{{ route('regnew') }}">
                ...
                <input class="form-control {{ $errors->has('agency') ? ' is-invalid' : '' }}" placeholder="{{ __('Agency') }}" type="text" name="agency" value="{{ old('agency') }}" required autofocus>
                ...
                <div class="input-group {{ $errors->has('division') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('division') ? ' is-invalid' : '' }}" placeholder="{{ __('Division') }}" type="text" name="division" value="{{ old('division') }}" required autofocus>
                ...
                <div class="input-group {{ $errors->has('contactNumber') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('contactNumber') ? ' is-invalid' : '' }}" placeholder="{{ __('Contact Number') }}" type="text" name="contactNumber" value="{{ old('contactNumber') }}" required autofocus>
                ...
                <div class="input-group {{ $errors->has('sex') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('sex') ? ' is-invalid' : '' }}" placeholder="{{ __('Sex') }}" type="text" name="sex" value="{{ old('sex') }}" required autofocus>
                    @if ($errors->has('sex'))
                        <span class="invalid-feedback" style="display: block;" role="alert">
                ...
                <div class="card-footer ">
                  <button type="submit" class="btn btn-primary btn-round btn-lg">{{__('Get')}}</button>
                </div>
              </form>
            </div>
          </div>
